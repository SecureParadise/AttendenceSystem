...
// Define type for admin's subject data
...
// Mock data for admin subjects
const mockAdminSubjects: AdminSubject[] = [
  createAdminSubject(1, "Operating Systems", "BP", 16, 13, 15),
  createAdminSubject(2, "Computer Networks", "PA", 12, 10, 12),
  createAdminSubject(3, "Database Management", "RKC", 14, 9, 14),
  createAdminSubject(4, "Filter Design", "BS", 10, 5, 10),
];
              ...
              {mockAdminSubjects.map((subject) => (
                ...
                >
                  <div className="p-4 flex flex-col h-full">
                    {/* Card Header: Subject Name & Teacher */}
                    <div className="mb-3">
