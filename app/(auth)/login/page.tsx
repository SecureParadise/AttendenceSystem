  ...
  const onSubmit = async (values: LoginFormType) => {
    ...
    try {
      const res = await fetch("/api/login", {
        ...
        body: JSON.stringify({
          ...values,
          rememberMe, // optional: send to backend
        }),
      });
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <Label
                      ...
                      className={`font-semibold flex items-center gap-2 ${
                        errors.email ? "text-red-600" : "text-blue-800"
                      }`}
                    >
                      <Mail size={16} />
                    ...
                    <div className="relative">
                      <Input
                        ...
                        {...register("email")}
                        className={`pl-12 h-12 rounded-xl text-lg border ${
                          errors.email
                  ...
                  <div className="space-y-3">
                    <Label
                      htmlFor="password"
                      className={`font-semibold flex items-center gap-2 ${
                        errors.password ? "text-red-600" : "text-blue-800"
                      }`}
                    >
                      <Lock size={16} />
                      Password *
                    ...
                    <div className="relative">
                      <Input
                        ...
                        {...register("password")}
                        className={`pl-12 pr-12 h-12 rounded-xl text-lg border ${
                          errors.password
                            ? "border-red-500 focus:border-red-500 focus:ring-red-500"
                            : "border-blue-200 focus:border-blue-500 focus:ring-blue-500"
                        }`}
                  ...
                  <div className="pt-4">
                    <Button
                      ...
                      className="w-full py-6 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
